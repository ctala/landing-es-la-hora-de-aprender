# Brief SEO — Hub `/guias/agentes-de-ia/`

> Producido por: agente SEO Content Distribution Strategist (2026-05-28)
> Funnel: B — signups a CAR Skool (AAS · LATAM `f970d84d`)
> Keyword target principal: `agentes de ia`
> Métrica norte: signups Skool con UTM `utm_campaign=hub_agentes_de_ia` > 0 en 90 días post-indexación
> Guardrails: no canibalizar ningún episodio específico; hub broad — cubrir el espacio amplio; 2 internal links a Skool máx; R1 — cero invención
...
| Keyword | ES (vol.) | MX (vol.) | ES comp. | Nota |
|---|---:|---:|---|---|
| **agentes de ia** | 1.000 | 720 | MEDIUM (61) | Head term. Pico abr-2026: 1.900 ES / 1.000 MX. CPC alto ($4.17 ES). |
| **agentes inteligencia artificial** | 30 | n.d. | MEDIUM (43) | Variante formal. Cubrir dentro del pillar. |
| **agente ia empresas** | n.d. | n.d. | — | Sin volumen medido pero intención B2B clara. Sección dedicada. |
| **como crear agentes de ia** | n.d. | n.d. | — | Sin datos ES/MX pero intención tutorial de alta conversión. H2 dedicado. |
| **agentes autonomos ia** | n.d. | n.d. | — | Cluster emergente. Cubrir en sección de tipos. |
| **n8n vs agentes ia** | n.d. | n.d. | — | Long-tail de alta intención técnica. Sección comparativa. |

**Nota de volumen:** "agentes de ia" muestra 1.000/mes ES (MEDIO), pero el CPC de $4.17 ES y $13.88 MX indica alta intención comercial. El volumen real es mayor — muchas variantes de cola larga no capturadas individualmente. Este hub captura el tráfico informacional + la conversion a funnel del AAS.

**Sub-keyword top descubierta:** el cluster "agentes de ia empresas" + "como crear agentes de ia" combinados son el núcleo de intención de quien busca aprender, no solo entender.
...
# 60 chars — head keyword adelante, tres intenciones: informacional + tutorial + acción
seoDescription: "Los agentes de IA no son chatbots: ejecutan tareas, mantienen memoria y trabajan solos. Qué son, tipos, cuándo usar n8n vs un agente, y cómo construir el primero."
# 161 chars — cubre qué son + diferenciador + comparativa + CTA a aprender
```
...
```
H1: Agentes de IA: qué son, cómo funcionan y cómo crear el tuyo

  H2: ¿Qué es un agente de IA?
    H3: La diferencia entre un chatbot y un agente
    H3: Los cuatro componentes de un agente: cerebro, memoria, herramientas y canal

  H2: Tipos de agentes de IA (y cuándo usar cada uno)
    H3: Agente personal vs agente temático en la empresa
    H3: Agente autónomo vs automatización agéntica determinística
    H3: La tabla de decisión: agente o automatización (n8n)

  H2: ¿Por qué los agentes de IA fallan cuando les hablas en español?
    H3: El problema del tool use en idiomas no ingleses
    H3: Cómo compensar mientras los modelos mejoran

  H2: Cómo crear un agente de IA desde cero
    H3: Elegir el cerebro (LLM) correcto para tu caso
    H3: Darle herramientas: conectar APIs sin que "sepa" usarlas
    H3: Construir skills reutilizables
    H3: El primer agente que de verdad funciona

  H2: Agentes de IA en la empresa: el debate que cambió de respuesta
    H3: Agente personal para cada empleado: por qué no escala
    H3: Agentes temáticos compartidos: la respuesta práctica de hoy
    H3: El rol emergente de agent ops

  H2: ¿Cuánto cuesta un agente de IA?
    H3: Costo del cerebro: opciones desde $0 hasta $200/mes
    H3: Costo del harness: OpenClaw, Hermes, Claude Code — gratis o casi

  H2: Lo que vimos pasar usando agentes en producción
    H3: El costo de adquisición a medio dólar con agentes de marketing
    H3: La empresa del trillón: por qué los agentes cambian el modelo de negocio

  H2: Preguntas frecuentes sobre agentes de IA
...
### Agentes de IA: qué son, cómo funcionan y cómo crear el tuyo
...
## Aprende a construir tu primer agente en CAR

El curso *Agentes IA: Starter Kit* en la comunidad Cágala, Aprende, Repite es el camino más directo para pasar de "entiendo qué es un agente" a "tengo un agente funcionando en producción". Cubre la arquitectura, la elección del cerebro, cómo construir skills y cómo conectar herramientas reales.

No es teoría de YouTube. Es lo que Cristian, Diego y Rodrigo han construido, roto y reconstruido en el podcast, empaquetado para que puedas replicarlo en tu contexto.
...
|---|---|---|
| `/episodios/01-openclaw-futuro-trabajo/` | "EP01 — OpenClaw y el futuro del trabajo" | Intro + recursos |
| `/episodios/04-agentes-vs-empleados/` | "EP04 — más agentes que empleados" | Empresa del trillón + recursos |
| `/episodios/05-openclaw-agentes-estrategia/` | "EP05 — estrategia con agentes" | Empresa + recursos |
| `/episodios/12-ley-ia-agentes-autonomos-modelo-default/` | "EP12 — agentes autónomos y modelo default" | Tipos + recursos |
| `/episodios/14-agentes-ia-empresa-uno-por-persona-o-equipo/` | "EP14 — agentes por persona o equipo" | Empresa + recursos |
| Hub `/guias/openclaw/` | "OpenClaw" | Sección harness + intro |
| Hub `/guias/hermes-agent/` | "Hermes Agent" | Sección cerebro + tipos |
| Hub `/guias/claude-code/` | "Claude Code" | Sección harness comparativa |
| Hub `/guias/n8n/` | "n8n para automatizaciones deterministas" | Sección agente vs automatización |
...
**URL con UTM:**
```
https://www.skool.com/cagala-aprende-repite/classroom/f970d84d?utm_source=eslahoradeaprender&utm_medium=organic&utm_campaign=hub_agentes_de_ia
```
...
description: "Los agentes de IA no son chatbots: ejecutan tareas, mantienen memoria y trabajan solos. Qué son, tipos, cuándo usar n8n vs un agente, y cómo construir el primero."
seoTitle: "Agentes de IA: qué son, cómo funcionan y cómo crear el tuyo"
seoDescription: "Los agentes de IA no son chatbots: ejecutan tareas, mantienen memoria y trabajan solos. Qué son, tipos, cuándo usar n8n vs un agente, y cómo construir el primero."
focusKeyword: "agentes de ia"
keywords:
...
funnel:
  ...
  cta: "El curso Agentes IA: Starter Kit en la comunidad Cágala, Aprende, Repite es el camino más directo para pasar de 'entiendo qué es un agente' a 'tengo un agente funcionando en producción'. Cubre la arquitectura, la elección del cerebro, cómo construir skills y cómo conectar herramientas reales. No es teoría de YouTube: es lo que Cristian, Diego y Rodrigo han construido, roto y reconstruido en el podcast, empaquetado para que puedas replicarlo."
...
faq:
  ...
  - question: "¿Cuándo usar un agente y cuándo usar n8n?"
    answer: "Si necesitas que el output sea idéntico cada vez, usa n8n (automatización determinista). Si la tarea requiere razonamiento sobre información no estructurada o decisiones de criterio, usa un agente. Para procesos con pasos fijos pero que necesitan IA en uno de esos pasos, combina n8n con un nodo de LLM."
  ...
  - question: "¿Cuánto cuesta tener un agente de IA funcionando?"
    answer: "El framework es gratuito (OpenClaw, Hermes, Claude Code son open source o gratis). El costo real es el LLM: desde $0 con modelos locales vía Ollama, hasta $20-40/mes con MiniMax o Claude Sonnet para uso diario. Con uso agéntico intensivo usando Opus la cuenta puede llegar a $200/mes."
---
```
...
1. **¿Agregar sección sobre CrewAI?** Cristian menciona CrewAI en EP11 y EP12 como la herramienta que le cambió la orquestación. El brief actual no tiene sección dedicada para no sobrecargar el hub broad. ¿Agregar H3 dentro de "cómo crear un agente" o diferir a una guía propia `/guias/crewai/`?

2. **¿Profundidad técnica de la sección de skills?** El draft cubre skills a nivel conceptual. Si la audiencia de ELHDA es más técnica de lo que parece, una sección con ejemplo de skill en formato YAML o Markdown podría aumentar el engagement. Verificar con analytics de la guía de claude-code una vez publicada.

3. **Compatibilidad de la tabla de "tipos de modelos" con la guía `/guias/gemini-vs-chatgpt/`:** ambas guías incluirán tablas comparativas de modelos. Verificar que no se contradigan — si en una pones que GPT-5.5 es "para generación rutinaria" y en la otra aparece como "premium", coordinar el mensaje.
