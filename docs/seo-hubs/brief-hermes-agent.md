# Brief SEO — Hub `/guias/hermes-agent/`

> Producido por: agente SEO Content Distribution Strategist (2026-05-28)
> Funnel: B — signups a CAR Skool (AAS · LATAM `f970d84d`)
> Keyword target principal: `hermes agent`
> Métrica norte: signups Skool con UTM `utm_campaign=hub_hermes_agent` > 0 en 90 días post-indexación
> Guardrails: alta intención, nicho técnico — mantener tono peer-to-peer; no canibalizar EP13/EP14; R1 — cero invención
...
|---|---:|---:|---|---|---|
| **hermes agent** | 1.300 | 390 | LOW (2) | Abr-2026: 12.100 ES / 4.400 MX | Head term. Explosión absoluta en abr-2026. CPC alto: $9.39 ES. |
| **nous research hermes** | 10 | n.d. | LOW (0) | Abr-2026: 30 ES | Branded. Cubrir en intro. |
| **hermes ia agente** | n.d. | n.d. | — | — | Long-tail emergente. Sección qué es. |
| **hermes vs openclaw** | n.d. | n.d. | — | — | Comparativa de alta intención. H2 dedicado. |
| **hermes dreaming feature** | n.d. | n.d. | — | — | Feature específica. Sección funcionalidades. |

**Nota de volumen:** el pico de abril 2026 (12.100 búsquedas en ES, 4.400 en MX) indica una adopción masiva reciente. El promedio móvil de 1.300/390 ya está contrayendo pero el CPC de $9.39 confirma intención de uso real, no solo curiosidad. Este es el momento óptimo para entrar con contenido de autoridad — el tema está caliente y aún tiene poca competencia (competition index: 2/100).

**Sub-keyword top descubierta:** `hermes agent` en el pico de abril 2026 (12.100 búsquedas en ES) es la señal de que hay una adopción masiva activa en la comunidad hispana. La guía captura a los que llegan tarde a la primera ola.
...
seoTitle: "Hermes Agent: qué es, cómo funciona y por qué supera a OpenClaw"
# 60 chars — head keyword adelante, comparativa implícita, promesa de diferenciación
seoDescription: "Hermes Agent de Nous Research es el agente de IA personal que superó a OpenClaw en instalaciones. Qué es, cómo funciona el dreaming, cómo migrar desde OpenClaw y cuándo usarlo."
# 178 chars — reducir:
# "Hermes Agent: el agente de IA que superó a OpenClaw en instalaciones. Qué es, la función dreaming, cómo migrar y cuándo elegirlo. Desde la cancha del podcast."
# 159 chars — perfecto
```
...
```
H1: Hermes Agent: qué es, cómo funciona y por qué la gente está migrando

  H2: ¿Qué es Hermes Agent?
    H3: Nous Research y el origen del proyecto
    H3: Hermes vs OpenClaw: la diferencia central

  H2: Las funciones de Hermes que importan
    H3: Dreaming: el agente que aprende de sus propios logs
    H3: Skill Bundles: paquetes de habilidades listos para conectar
    H3: El cerebro: qué modelos funcionan con Hermes hoy

  H2: ¿Por qué Hermes superó a OpenClaw en instalaciones?
    H3: El contexto: lo que pasó con Anthropic en marzo 2026
    H3: La migración de Cristian y Rodrigo (EP13, EP14)
    H3: Cuándo OpenClaw sigue teniendo sentido

  H2: Cómo empezar con Hermes Agent
    H3: Requisitos previos
    H3: Instalación básica
    H3: Primeras configuraciones: cerebro, canal y skills

  H2: Hermes en producción: casos de uso reales del podcast
    H3: El agente mayordomo de Rodrigo: de Granola a Todoist
    H3: Research local con Hermes en DGX Spark
    H3: Cuándo Hermes no es la respuesta correcta

  H2: Preguntas frecuentes sobre Hermes Agent
...
### Hermes Agent: qué es, cómo funciona y por qué la gente está migrando
...
## Aprende a construir tu stack agéntico en CAR

El curso *Agentes IA: Starter Kit* en Cágala, Aprende, Repite cubre la arquitectura de agentes — incluyendo la elección entre OpenClaw, Hermes y Claude Code según el caso de uso — junto con cómo elegir el cerebro, construir skills y conectar herramientas reales.
...
|---|---|---|
| `/episodios/13-karpathy-anthropic-fichaje-rompe-ia/` | "EP13 — Karpathy a Anthropic" | Migración + recursos |
| `/episodios/14-agentes-ia-empresa-uno-por-persona-o-equipo/` | "EP14 — agentes por persona o por equipo" | Casos de uso + recursos |
| `/episodios/08-crisis-anthropic-modelos-alternativos-ia-local/` | "EP08 — crisis Anthropic" | Contexto migración + recursos |
| Hub `/guias/openclaw/` | "OpenClaw" | Sección comparativa |
| Hub `/guias/agentes-de-ia/` | "qué son los agentes de IA" | Intro + tipos |
| Hub `/guias/claude-code/` | "Claude Code" | Sección cuándo elegir cada harness |
...
**URL con UTM:**
```
https://www.skool.com/cagala-aprende-repite/classroom/f970d84d?utm_source=eslahoradeaprender&utm_medium=organic&utm_campaign=hub_hermes_agent
```
...
description: "Hermes Agent de Nous Research superó a OpenClaw en instalaciones en mayo 2026. Qué es, la función dreaming, qué modelos funcionan, y cómo migrar desde OpenClaw. Desde la cancha del podcast."
seoTitle: "Hermes Agent: qué es, cómo funciona y por qué supera a OpenClaw"
seoDescription: "Hermes Agent: el agente de IA que superó a OpenClaw en instalaciones. Qué es, la función dreaming, cómo migrar y cuándo elegirlo. Desde la cancha del podcast."
focusKeyword: "hermes agent"
keywords:
  - "hermes agent"
  - "nous research hermes"
  - "hermes vs openclaw"
  - "hermes dreaming feature"
  - "hermes agent ia"
  - "hermes skill bundles"
  - "agente ia personalizado"
  - "nous research agente"
...
funnel:
  ...
  cta: "El curso Agentes IA: Starter Kit en Cágala, Aprende, Repite cubre la arquitectura de agentes — incluyendo la elección entre OpenClaw, Hermes y Claude Code — junto con cómo elegir el cerebro, construir skills y conectar herramientas reales. Lo ves, lo replicás. CAR es educación."
...
faq:
  ...
  - question: "¿Es Hermes gratis?"
    answer: "El framework es de código abierto. El costo viene del LLM que uses como cerebro: desde $0 con modelos locales vía Ollama, hasta las suscripciones de MiniMax, GPT-5.5 o los modelos que elijas."
...
1. **¿Incluir tutorial de instalación más detallado?** El draft incluye el proceso a alto nivel. Dado que el perfil es técnico (competition index 2, nicho de early adopters), una sección más detallada con troubleshooting común podría aumentar el tiempo en página y señalizar autoridad. Decisión: ¿agregar o linkear a documentación oficial?

2. **¿Agregar sección de comparativa con Gemini Spark?** En EP14 se menciona que Gemini Spark es "la amenaza a largo plazo" para los agentes personales instalados localmente. ¿Incluir una H3 de "Hermes vs Gemini Spark" o diferir a cuando Gemini Spark sea accesible fuera de EE.UU.?

3. **Actualización rápida obligatoria:** el estado de Hermes vs OpenClaw puede cambiar en semanas. Este hub necesita un proceso de revisión frecuente (30 días). ¿Tienes algún sistema de alertas para cuando Hermes lanza features o cambia pricing?
