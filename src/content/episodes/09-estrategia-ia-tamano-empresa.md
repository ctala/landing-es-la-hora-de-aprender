...
- **[Claude Desbloqueado — curso de Rodrigo](https://www.linkedin.com/in/rodrigorojop/)** — Nueva edición arranca el lunes 27 de abril, 4 sesiones con los detalles de Claude.
- **[OpenClaw](https://openclaw.ai)** — Framework de agentes, base de los setups comentados por los tres hosts.
- **[MiniMax](https://www.minimax.io/)** — Suscripción de ~$40/mes que alimenta OpenClaw sin quedarse sin tokens.
- **[HeyGen](https://www.heygen.com/)** — Clonación de avatar en video; Avatar 5.5 y la nueva librería open source Hyperframes.
- **[GenSpark](https://genspark.com/)** — Plataforma de agentes empaquetada, especialmente útil para equipos comerciales.
- **[Ollama](https://ollama.com/)** — Runtime para correr modelos open source como Gemma localmente.
