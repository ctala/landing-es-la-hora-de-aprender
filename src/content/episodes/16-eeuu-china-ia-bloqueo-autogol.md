---
title: "EE.UU. vs China en IA: ¿el bloqueo es un autogol?"
episode: 16
season: 1
thumbnail: "/thumbnails/ep16.webp"
date: "2026-06-30"
duration: "1:02:58"
durationSeconds: 3778
youtube: "https://www.youtube.com/watch?v=PsChVRMW5Kc"
youtubeId: "PsChVRMW5Kc"
spotify: "https://open.spotify.com/episode/1Dhdsc9yb2BFZFtRky7ZQE"
description: "EE.UU. bloqueó Fable 5 y le cerró a China el hardware de Nvidia. La tesis de los tres hosts: es un autogol que acelera a los modelos chinos. De GLM 5.2 a MiniMax y Kimi, por qué 'abierto no es gratis' y el plan de contingencia que todo founder necesita."
seoTitle: "EE.UU. vs China en IA: por qué el bloqueo es un autogol | EP16"
seoDescription: "Episodio 16: por qué bloquear a China en IA es un autogol, GLM 5.2 y MiniMax vs la frontera, cuánto cuesta correr un modelo abierto y por qué tener plan B."
ogImage: "https://eslahoradeaprender.com/thumbnails/ep16.webp"
hosts:
  - name: "Cristian Tala"
...
topics:
  - "EE.UU. vs China: el bloqueo de IA como autogol geopolítico"
  - "Fable 5, Mythos 5 y el veto a modelos para no estadounidenses"
  - "GLM 5.2, MiniMax M3 y Kimi 2.7: los modelos chinos abiertos"
  - "Abierto no es gratis: el hardware real para correr un modelo grande"
  - "Anthropic acusa a Alibaba de destilación"
  - "Del token-maxing a medir impacto real en las empresas"
  - "Agentes en la nube vs en tu propio computador"
  - "Diffusion Gemma: generar texto por difusión"
  - "Planificación overnight con modelos locales en el DGX Spark"
  - "Plan de contingencia: no depender de un solo modelo"
relatedEpisodes: [8, 14, 15]
keywords:
  - "estados unidos vs china inteligencia artificial"
  - "bloqueo nvidia china autogol"
  - "glm 5.2 que es"
  - "modelos chinos ia mas baratos"
  - "minimax m3 vs claude"
  - "cuanto cuesta correr modelo open source local"
  - "fable 5 bloqueo estados unidos"
  - "agentes ia nube vs local"
  - "diffusion gemma texto"
  - "plan de contingencia modelos ia"
keyTakeaways:
  - "Por qué bloquear el hardware y los modelos de frontera a China funciona como autogol: acelera el ecosistema abierto chino en vez de frenarlo"
  - "Que un modelo sea abierto no significa gratis: correr GLM 5.2 a velocidad de API puede costar medio millón de dólares en hardware"
  - "Por qué modelos chinos como MiniMax M3 ya compiten de igual a igual en tareas reales, y dónde todavía pierden"
  - "La métrica que de verdad importa no es cuántos tokens gastas sino qué resultado obtienes con ellos"
  - "El plan de contingencia que todo founder fuera de EE.UU. necesita: stack diversificado para que una decisión política no apague tu operación"
timestamps:
  - time: "00:00"
    seconds: 0
    label: "Apertura: el terremoto de Venezuela y la alerta de Google"
  - time: "02:00"
    seconds: 120
    label: "Las cinco herramientas de IA que Rodrigo usa a diario"
  - time: "05:10"
    seconds: 310
    label: "Diego: Hermes en Slack y el CRM que se llena solo"
  - time: "08:14"
    seconds: 494
    label: "'El SaaS ha muerto': el CRM sin dashboard de Cristian"
  - time: "12:38"
    seconds: 758
    label: "La tesis del episodio: ¿el bloqueo de EE.UU. es un autogol?"
  - time: "17:14"
    seconds: 1034
    label: "Anthropic acusa a Alibaba de destilación"
  - time: "18:12"
    seconds: 1092
    label: "GLM 5.2, Z.ai +30% en bolsa y la frontera que se acorta"
  - time: "20:10"
    seconds: 1210
    label: "'Abierto no es gratis': los 500 mil dólares de hardware"
  - time: "23:42"
    seconds: 1422
    label: "Plan B y modelos demasiado restrictivos"
  - time: "25:13"
    seconds: 1513
    label: "MiniMax vs Claude: el caso de los correos"
  - time: "29:02"
    seconds: 1742
    label: "Del token-maxing a medir impacto real"
  - time: "38:00"
    seconds: 2280
    label: "Diffusion Gemma: generar texto por difusión"
  - time: "44:00"
    seconds: 2640
    label: "¿Agentes en la nube o en local? La confesión de Cristian"
  - time: "51:36"
    seconds: 3096
    label: "Peter Levels y trabajar en producción desde el celular"
  - time: "56:46"
    seconds: 3406
    label: "Cierre: identifica tus procesos y ten plan de contingencia"
resources:
  - title: "OpenClaw"
    url: "https://openclaw.ai"
    type: "tool"
    description: "El agente personal 24/7 que dio origen al primer episodio del podcast. Rodrigo lo usa como Chief of Staff."
  - title: "Hermes (Nous Research)"
    url: "https://nousresearch.com/"
    type: "tool"
    description: "El agente que Cristian corre en cada uno de sus computadores; en el Spark lo usa con MiniMax M3 como modelo principal."
  - title: "MiniMax"
    url: "https://www.minimax.io/"
    type: "tool"
    description: "MiniMax M3, el modelo chino favorito de Cristian y Diego para trabajo agéntico. MiniMax Code, en cambio, todavía deja que desear."
  - title: "Z.ai (GLM 5.2)"
    url: "https://z.ai/"
    type: "tool"
    description: "La empresa detrás de GLM 5.2; subió 30% en bolsa el día que liberó el modelo abierto."
  - title: "Qwen"
    url: "https://qwen.ai/"
    type: "tool"
    description: "Qwen 3.6 de Alibaba, uno de los modelos que Cristian corre local en el Spark."
  - title: "Ollama"
    url: "https://ollama.com/"
    type: "tool"
    description: "Una de las formas de correr modelos abiertos como GLM 5.2 localmente."
  - title: "OpenRouter"
    url: "https://openrouter.ai/"
    type: "tool"
    description: "Plataforma para acceder a modelos abiertos a centavos por token, sin comprar el hardware."
  - title: "Granola"
    url: "https://www.granola.ai/"
    type: "tool"
    description: "La herramienta que Rodrigo usa para grabar reuniones y clases — la materia prima que después alimenta el CRM."
  - title: "Twenty"
    url: "https://twenty.com/"
    type: "tool"
    description: "El CRM open source que Cristian usó antes de pasarse a una base de datos sin dashboard consultada por agentes."
  - title: "Claude Code"
    url: "https://www.claude.com/product/claude-code"
    type: "tool"
    description: "Desde donde Cristian rutea sus subagentes; el episodio adelanta que pronto delegará al subagente por defecto."
  - title: "Benchmark de IA para emprendedores"
    url: "https://benchmarks.cristiantala.com/"
    type: "tool"
    description: "El benchmark de Cristian con casos en español; la edición de julio incluye Fable 5, GLM 5.2 y Kimi 2.7."
  - title: "Blog de Cristian Tala"
    url: "https://cristiantala.com/"
    type: "article"
    description: "Donde Cristian publicó su estudio de cuánto hardware hace falta para correr GLM 5.2 a velocidad de API."
---
...
- **[OpenClaw](https://openclaw.ai)** — el agente personal 24/7 que dio origen al podcast
- **[Hermes (Nous Research)](https://nousresearch.com/)** — el agente que Cristian corre local en cada máquina
- **[MiniMax](https://www.minimax.io/)** — M3 para trabajo agéntico; MiniMax Code todavía flojo
- **[Z.ai](https://z.ai/)** — la empresa detrás de GLM 5.2, +30% en bolsa al liberarlo
- **[Qwen](https://qwen.ai/)** — el 3.6 de Alibaba, uno de los locales de Cristian
- **[Ollama](https://ollama.com/)** y **[OpenRouter](https://openrouter.ai/)** — dos formas de correr o acceder a modelos abiertos
- **[Granola](https://www.granola.ai/)** — grabación de reuniones que alimenta el CRM
- **[Twenty](https://twenty.com/)** — el CRM open source que Cristian usó antes de la base sin dashboard
- **[Claude Code](https://www.claude.com/product/claude-code)** — desde donde Cristian rutea sus subagentes
- **[Benchmark de IA para emprendedores](https://benchmarks.cristiantala.com/)** — casos en español; edición de julio con Fable 5, GLM 5.2 y Kimi 2.7
- **[Blog de Cristian Tala](https://cristiantala.com/)** — donde está el cálculo del hardware para correr GLM 5.2
