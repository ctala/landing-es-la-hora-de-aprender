---
title: "Desempleo, agentes 24/7 y la carta de Dario Amodei"
episode: 22
season: 1
thumbnail: "/thumbnails/ep22.webp"
date: "2026-09-14"
duration: "53:45"
...
topics:
  - "OpenAI y los 10.000 agentes que trabajaron 88 horas sobre Navier-Stokes"
  ...
  - "Hermes Desktop: el agente en una máquina, la app en cualquiera"
...
keywords:
  ...
  - "openai resolvio problema matematico con agentes"
  - "navier stokes inteligencia artificial"
  - "desempleo por inteligencia artificial chile 2026"
  - "la ia crea o destruye empleo"
  - "manejar un negocio con agentes de ia 24/7"
  - "grok bot opiniones"
...
keyTakeaways:
  ...
  - "El ensayo de Dario Amodei pide pausar la frontera, no frenarla, y todos los grandes dicen estar de acuerdo mientras ninguno quiere ser el primero en sumarse"
timestamps:
  - time: "00:01"
    seconds: 1
    label: "Episodio 22: matemáticos vs OpenAI, desempleo y el ensayo de Amodei"
  - time: "01:20"
    seconds: 80
    label: "Un lunes de 175 noticias: el pipeline de Ecosistema Startup"
  - time: "06:00"
    seconds: 360
    label: "Hermes Desktop: el agente en una máquina, la app en cualquiera"
  - time: "10:10"
    seconds: 610
    label: "Clones virtuales: ocho proveedores probados y ganó HeyGen"
  - time: "14:00"
    seconds: 840
    label: "Grok Bot: la tarjeta, la publicidad y el reto de tres días"
  - time: "16:10"
    seconds: 970
    label: "Muse, bots en vez de sesiones y el miedo al terminal"
  - time: "20:30"
    seconds: 1230
    label: "Puedo manejar un negocio entero solo con agentes"
  - time: "23:50"
    seconds: 1430
    label: "Matemáticos vs OpenAI: 10.000 agentes y 88 horas"
  - time: "27:10"
    seconds: 1630
    label: "Navier-Stokes, Lean y por qué todo es un remix"
  - time: "31:20"
    seconds: 1880
    label: "Día del programador: un año sin tocar código"
  - time: "32:00"
    seconds: 1920
  ...
  - time: "45:50"
    seconds: 2750
    label: "El ensayo de Dario Amodei: pausar, no frenar"
  - time: "50:05"
    seconds: 3005
    label: "Cierre: deja al agente con /goal y sigue aprendiendo"
resources:
  - title: "Ensayos de Dario Amodei"
    url: "https://www.darioamodei.com"
    type: "article"
    description: "El sitio donde publica sus ensayos, incluido el que comentan en el episodio: We Must Pace the Frontier."
  - title: "Machines of Loving Grace"
    url: "https://www.darioamodei.com/essay/machines-of-loving-grace"
    type: "article"
    description: "El ensayo clásico de Amodei que Rodrigo usa como contraste con el nuevo."
  - title: "Lean"
    url: "https://lean-lang.org"
    type: "tool"
    description: "El asistente de pruebas formales donde GPT-6 Astra habría verificado la demostración durante 17 horas."
  - title: "AlphaFold"
    url: "https://deepmind.google/technologies/alphafold/"
    type: "other"
    description: "El precedente que cita Rodrigo: miles de proteínas predichas que los científicos todavía están replicando en laboratorio."
  - title: "OpenSpec"
    url: "https://github.com/Fission-AI/OpenSpec"
    type: "repo"
    description: "La skill de Spec Driven Development que recomienda Rodrigo: el agente te entrevista, escribe la especificación y luego la ejecuta."
  - title: "Claude Code"
    url: "https://claude.com/claude-code"
    type: "tool"
    description: "Uno de los entornos donde conectan OpenSpec, junto a Codex y Cursor."
  - title: "Hermes (Nous Research)"
    url: "https://nousresearch.com"
    type: "tool"
    description: "El agente que usan los tres. Su aplicación de escritorio ya se instala en cualquier equipo y se conecta a la máquina donde vive el agente."
  - title: "Grok"
    url: "https://grok.com"
    type: "tool"
    description: "La casa de Grok Bot, el agente que probaron Diego y Cristian esta semana."
  - title: "HeyGen"
    url: "https://www.heygen.com"
    type: "tool"
    description: "Ganó el benchmark de ocho proveedores de clones virtuales que armó Cristian, pese a ser el más caro."
  - title: "EchoMimic v3"
    url: "https://github.com/antgroup/echomimic_v3"
    type: "repo"
    description: "Uno de los modelos locales de clonación que Cristian probó y descartó por el acabado demasiado estilizado."
  - title: "Hugging Face"
    url: "https://huggingface.co"
    type: "other"
    description: "Donde Rodrigo busca modelos puntuales para correr en su tarjeta local."
  - title: "n8n"
    url: "https://n8n.io"
    type: "tool"
    description: "El orquestador del pipeline de noticias de Ecosistema Startup, que hoy llama microservicios en Python."
  - title: "Sentry"
    url: "https://sentry.io"
    type: "tool"
    description: "Cómo Cristian sabe si un flujo falló o no."
  - title: "Ecosistema Startup"
    url: "https://ecosistemastartup.com"
    type: "other"
    description: "El medio de Cristian: 175 noticias en un lunes y un directorio armado solo con información validada."
faq:
...
| Herramienta | Qué ofrece | Lo que notaron esta semana |
|---|---|---|
| Grok Bot | Agentes que creas ahí mismo y viven en la nube | Fácil de usar; el plan de US$20 se agota en un día para un usuario intensivo; le falta inteligencia en algunas tareas |
| Muse (Meta) | Agente por cuenta, en lista de espera | Recién abrió inscripciones |
| Spark (Google) | Incluido en el plan de US$20 de Google AI | Funciona muy bien; conectores MCP a mano; el modelo detrás no es el de frontera; Google no lo promociona |
| Hermes Desktop | App en cualquier equipo conectada a la máquina del agente | Listas de tareas, skills visibles, modelo por función, modo bot; ya no requiere consola |
...
- **[Ensayos de Dario Amodei](https://www.darioamodei.com)** — donde publica We Must Pace the Frontier y el clásico [Machines of Loving Grace](https://www.darioamodei.com/essay/machines-of-loving-grace).
- **[Lean](https://lean-lang.org)** — el asistente de pruebas formales donde se habría verificado la demostración de Navier-Stokes.
- **[AlphaFold](https://deepmind.google/technologies/alphafold/)** — el precedente de Rodrigo: proteínas predichas por IA que la ciencia sigue replicando.

**Programar con agentes**

- **[OpenSpec](https://github.com/Fission-AI/OpenSpec)** — la skill de Spec Driven Development que recomienda Rodrigo.
- **[Claude Code](https://claude.com/claude-code)** — uno de los entornos donde se conecta, junto a Codex y Cursor.
- **[Hermes](https://nousresearch.com)** — el agente de los tres; su aplicación de escritorio ya no requiere consola.
- **[Grok](https://grok.com)** — la casa de Grok Bot, el agente que probaron Diego y Cristian.

**Clones y producción**

- **[HeyGen](https://www.heygen.com)** — ganó el benchmark de ocho proveedores de clones virtuales de Cristian.
- **[EchoMimic v3](https://github.com/antgroup/echomimic_v3)** — uno de los modelos locales que probó y descartó.
- **[Hugging Face](https://huggingface.co)** — donde Rodrigo encuentra modelos puntuales para su tarjeta local.

**El pipeline de noticias**

- **[n8n](https://n8n.io)** y **[Sentry](https://sentry.io)** — el orquestador y las alertas detrás de [Ecosistema Startup](https://ecosistemastartup.com).
...
- [EP10 — ¿Para qué servimos los humanos si la IA es tan buena?](/episodios/10-humanos-era-ia-power-skills) — las habilidades que quedan.
